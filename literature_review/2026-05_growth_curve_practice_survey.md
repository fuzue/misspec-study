...
3. **The specific question — coverage of growth-curve CIs under structural misspecification — has not been answered in the published literature.** The two closest existing studies are Simpson et al. (2021, *J. Theor. Biol.*; 73 citations) on profile-likelihood identifiability across logistic/Gompertz/Richards, and Rockaya & Baranyi (2025, *Food Microbiology*) on SE realism after reparametrization — both in the **well-specified** case. The Bayesian-growth-curve antecedents (Pouillot 2003 — 122 cites; Powell 2006 — 17 cites; Quinto 2018 — 0 cites) report credible intervals without coverage assessment. The predictive-microbiology validation literature (ComBase tradition) reports Af/Bf on point predictions, never CI coverage.
